...
// {
	...
	$pwd=$_POST['pwd'];
	$res=mysqli_query($conn,"SELECT * FROM admindata WHERE username='$username'");
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown" id = "new">
					  ...
					  <li class="dropdown" id = "old">
						<a class="dropdown-toggle" data-toggle="dropdown" href="#" ><span class="glyphicon glyphicon-user" id="wuser"></span>
